...
//		demoFile();
	...
	private static void demoPrintf() {
		...
		System.out.printf("Value 1: %d %d%n", 9, 1111);
		System.out.printf("Value 2: %d %d%n", 154651, 1);
		System.out.printf("Value 3: %d %d%n", 574, 45);
		...
		System.out.printf("Value 1: %7d %7d%n", 9, 1111);
		System.out.printf("Value 2: %7d %7d%n", 154651, 1);
		System.out.printf("Value 3: %7d %7d%n", 574, 45);
